...
export default function AboutCenter() {
  ...
  return (
    <>
    <Grid className={classes.car} rowspacing={2} style={{marginTop:"-5px"}}>
          <Grid sx={{ width: "800px",marginTop:"0px" }}>
            ...
            Speedo Car Rental is a leading cab rental company. We have a
              wide range of car fleet which includes economy cars, SUV and MUV
        ...
        <Grid className={classes.car} rowspacing={2} >
          ...
          <Grid sx={{ width: "800px" }}>
            ...
            <Box sx={{ mt: 1 }} className={classes.word1}>Competitive Prices</Box>
            <Box sx={{ mt: 1 }} className={classes.word1}>Breakdown Assistance</Box>
            <Box sx={{ mt: 1 }} className={classes.word1}>Trusted Rent Service</Box>
            <Box sx={{ mt: 1 }} className={classes.word1}>24x7 Customer Support</Box>
